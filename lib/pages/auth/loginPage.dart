                ...
                children: [
                  ...
                  const Padding(
                    padding: EdgeInsets.only(
                        top: defaultPaddingSpace, bottom: defaultPaddingSpace),
                    child: Icon(
                      Icons.lock,
                      size: 50,
                      color: mainTextColor,
                  ...
                  AuthTextField(
                    textController: loginEmailInput,
                    hintTextValue: "Email",
                    obscurveText: false,
                  ...
                  AuthTextField(
                    textController: loginPasswordInput,
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                        ...
                        children: const [
                          Padding(
                            padding: EdgeInsets.only(
                                right: 30.0, top: 15.0, bottom: 50.0),
                            child: Text(
                              "Forget password?",
                              style: TextStyle(
                                color: mainTextColor,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () => {
                        auth.loginIn(context, loginEmailInput.text,
