...
import 'package:testapp/components/myPopUp.dart';
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(
                    vertical: 20.0, horizontal: defaultPaddingSpace),
  ...
  _createUser() async {
    ...
    await authController.createUser(
      newClient: Client(
          ...
          clientEmail: emailInput.text,
          clientPassword: passwordInput.text,
          clientPhoneNumber: phoneNumberInput.text),
    );
  }
}
